...
class APIManager {
    ...
    // Upload Image
    class func uploadImage(with image: Data, completion: @escaping (Bool) -> Void) {
        ...
        AF.upload(multipartFormData: { (formData) in
            formData.append(image, withName: "avatar", fileName: "/home/ali/Mine/c/nodejs-blog/public/img/blog-header.jpg", mimeType: "blog-header.jpg")
